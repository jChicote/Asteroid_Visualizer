...
export class HorizonsApiGateway {
    ...
    async GetPlanetEphemerisData(planetCode) {
        ...
        try {
            ...
            planetData.captureData = this.ExtractCaptureData(response);
            planetData.heliocentricData = this.ExtractHeliocentricData(response);
            planetData.physicalBodyData = this.GetPlanetPhysicalBody(response);
    ...
    ExtractHeliocentricData(response) {
    ...
    GetPlanetPhysicalBody(response) {
